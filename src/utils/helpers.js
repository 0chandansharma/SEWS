/**
 * Utility functions for generating structured data schemas for SEO
 */
...
const companyInfo = {
   ...
   * @returns {Object} - Structured data for Article
   */
  export const getArticleSchema = (articleData) => {
    const { title, description, url, image, datePublished, dateModified, author } = articleData;
  ...
  /**
   * Generate Product schema for equipment or products
   * 
   * @param {Object} productData - Product-specific data
   * @returns {Object} - Structured data for Product
   */
   ...
   * 
   * @returns {Object} - Structured data for WebSite
   */
